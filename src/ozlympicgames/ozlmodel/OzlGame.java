...
public class OzlGame {
    ...
    private Timestamp timeRun;

    // Constructor
    public OzlGame(String _id) {
     ...
     */
    public void addParticipant(GamesParticipant participant) throws OzlGameFullException, WrongSportException {
     ...
     */
    public List<GamesAthlete> getGameAthletesWinnersSortedByTime() throws GameNeverPlayedException {
        if (!gamePlayed) {
