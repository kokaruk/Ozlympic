...
class OzlGameTest {
    ...
    class gamePlayTest{
        ...
        void setUp(){
            ...
            when(configReaderMock.getConfigInt("MIN_PARTICIPANTS", modelPackageConfig.MODEL_COFIG_FILE)).thenReturn(3);
            when(configReaderMock.getConfigInt("MAX_PARTICIPANTS", modelPackageConfig.MODEL_COFIG_FILE)).thenReturn(4);
            //Game.Id
    ...
    class addParticipantTests {
        ...
        void configReaderSetUp(){
            when(configReaderMock.getConfigInt("MIN_PARTICIPANTS", modelPackageConfig.MODEL_COFIG_FILE)).thenReturn(1);
            when(configReaderMock.getConfigInt("MAX_PARTICIPANTS", modelPackageConfig.MODEL_COFIG_FILE)).thenReturn(1);
        }
